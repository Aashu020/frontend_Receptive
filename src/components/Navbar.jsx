...
const Navbar = () => {
  ...
  return (
    <header ref={navRef} className="relative top-11 ">
      {/* Upper Header */}
      <UpperHeader />

      {/* Main Navbar */}
      <nav className={`bg-white/95 backdrop-blur-md border-b border-gray-200 sticky  z-100 transition-all duration-300 ${
