            ...
            <div className="lg:col-span-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-[#D8C287] p-4 rounded-lg">
                  ...
                  <p className="text-[#0c3b34] text-xs font-medium">+91 77380 56424</p>
                  <p className="text-[#0c3b34] text-xs font-medium ">info@receptivesolutions.co.in</p>
                </div>
                ...
                <div className="bg-[#D8C287] p-4 rounded-lg">
                  ...
                  <p className="text-[#0c3b34] text-xs font-medium">+91 8104767778</p>
                  <p className="text-[#0c3b34] text-xs font-medium">ketan@receptivesolutions.co.in</p>
                </div>
              </div>
            </div>
          </div>
