...
export default function ReceptiveAbout() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-16 bg-[#F8F8F8]">
      <div className="flex flex-col items-center">
        {/* Animated Logo */}
        <div className={`mb-10 w-72 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <img
            src={logo}
            alt="Receptive Group"
        ...
        <div className="text-center max-w-3xl">
          <h1 className={`text-4xl font-bold bg-gradient-to-r from-[#D8C287] to-[#0C3B34] bg-clip-text mb-8 transform transition-all duration-700 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'}`}>
            Welcome to Receptive Group of Companies
          </h1>
          
          <div className="text-[#333333] text-lg leading-relaxed space-y-6">
            ...
            <div className={`p-6 bg-gradient-to-r from-[#0C3B34]/10 to-[#0C3B34]/5 rounded-xl border-l-4 border-[#D8C287] transform transition-all duration-700 delay-800 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-6 opacity-0'}`}>
              <p className="font-semibold text-[#0C3B34] text-xl">
