        ...
        <div className="flex flex-col gap-4 sm:gap-6 md:gap-8 mt-6 sm:mt-8 md:mt-12">
            ...
            <div className="flex items-center gap-3 sm:gap-4 md:gap-6 flex-shrink-0 pl-2 md:pl-0">
                <div className="bg-[#0C3B34] p-2 sm:p-3 md:p-4 rounded-full">
                    <IconComponent className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 2xl:w-10 2xl:h-10 text-[#D8C287]" />
                </div>
                <h2 className="text-2xl sm:text-xl md:text-2xl 2xl:text-4xl font-bold text-[#0C3B34] xl:text-3xl">
                    {title}
                </h2>
            </div>
            ...
            <div className="flex-1 px-2 sm:px-4 md:px-2">
                <div className="prose prose-sm sm:prose-base md:prose-lg max-w-none text-gray-700 text-sm md:text-[15px] xl:text-lg 2xl:text-2xl">
                    {children}
                </div>
            </div>
        </div>
...
const Section1 = ({ icon, title, children }) => {
    ...
    return (
        <div className="flex flex-col  gap-4 sm:gap-6 md:gap-8 mt-6 sm:mt-8 md:mt-12" id="company-investor-visa">
            ...
            <div className="flex items-center  gap-3 sm:gap-4 md:gap-6 flex-shrink-0 pl-2 md:pl-0">
                <div className="bg-[#0C3B34] p-2 sm:p-3 md:p-4 rounded-full">
                    <IconComponent className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 2xl:h-10 2xl:w-10 text-[#D8C287]" />
                </div>
                <h3 className="text-lg text-center sm:text-xl md:text-2xl font-bold text-[#0C3B34] xl:text-3xl 2xl:text-4xl">
                    {title}
                </h3>
            </div>
            ...
            {/* Right side: Content */}
            <div className="flex-1 px-2 sm:px-4 md:px-2">
                <div className="prose prose-sm sm:prose-base md:prose-lg max-w-none text-gray-700 text-sm md:text-[15px] xl:text-lg 2xl:text-3xl">
                    {children}
                </div>
            </div>
        </div>
        ...
        >
            <div className="flex items-center gap-4">
                <div className="flex-shrink-0 w-8 h-8 lg:w-12 lg:h-12 flex items-center justify-center rounded-full bg-[#D8C287]/10 border-2 border-[#D8C287]/30">
                    <span className="text-xl 2xl:text-2xl font-bold text-[#0C3B34]">{number}</span>
                </div>
                <h3 className="text-md font-semibold text-[#0C3B34] flex-1 text-left" style={{ wordSpacing: "4px" }}>{title}</h3>
            </div>
            <p className="mt-4 text-gray-600 md:text-[13px] 2xl:text-2xl">{displayText}</p>
            {shouldTruncate && (
                <button
                    onClick={handleToggle}
                    className="mt-2 text-[#0C3B34] hover:text-[#D8C287] text-sm 2xl:text-2xl 2xl:my-2 font-medium transition-colors duration-200"
                    type="button"
                >
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                <div className="p-4 sm:p-6 md:p-12 text-justify">
                    ...
                    <div className="text-center mb-8 sm:mb-12">
                        <h1 className="text-2xl sm:text-3xl md:text-4xl xl:text-4xl 2xl:text-5xl font-extrabold text-[#0C3B34]">
                            UAE Residence Visas
                        </h1>
                        <p className="mt-3 sm:mt-4 text-base sm:text-lg text-gray-600 max-w-3xl mx-auto xl:text-xl 2xl:text-2xl">
                    ...
                    <div className="bg-[#0C3B34] text-white rounded-xl p-4 sm:p-6 md:p-8 mb-8 sm:mb-12">
                        <h2 className="text-lg sm:text-2xl md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-bold text-[#D8C287] mb-3">
                        ...
                        <div className="flex flex-col md:flex-row gap-4 items-center xl:items-start xl:gap-12 xl:pt-8">
                            <p className="opacity-90 text-sm sm:text-base md:flex-1 md:text-sm xl:text-xl 2xl:text-3xl">
                            ...
                            <div className="w-full md:w-[45%] xl:w-[35%] 2xl:w-[40%]">
                    ...
                    <div className="rounded-xl p-4 sm:p-6 md:p-8 mb-8 sm:mb-12">
                        <h2 className="text-xl sm:text-2xl md:text-lg 2xl:text-4xl font-bold text-[#0C3B34] mb-3 xl:text-2xl">
                            Understanding the Different Types of Residency Visas in UAE
                        </h2>
                        <p  className="opacity-90 text-sm sm:text-base md:text-[15px] xl:text-lg 2xl:text-3xl">
                    ...
                    <Section icon={Gem} title="1. UAE Golden Visa">
                        <div id="golden-visa">
                            ...
                            <h3 className="text-xl sm:text-2xl  font-bold text-center text-[#0C3B34] mt-6 sm:mt-8 mb-4 sm:mb-6 xl:text-3xl 2xl:text-4xl 2xl:py-4">
                                The Top 13 Benefits of the UAE Golden Visa
                            </h3>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 xl:text-2xl 2xl:text-3xl">
                    ...
                    <Section1 icon={Building2} title="Company Investor Visa" >
                        <div>
                            ...
                            <ul className="list-disc pl-4 sm:pl-6 mt-3 sm:mt-4 space-y-1 sm:space-y-2 text-sm sm:text-base md:text-[14px] xl:text-[16px] 2xl:text-3xl 2xl:leading-relaxed 2xl:tracking-wider">
                    ...
                    <Section1 icon={Briefcase} title="UAE Employment Visa" >
                        ...
                        <ul className="list-disc pl-4 sm:pl-6 mt-3 sm:mt-4 space-y-1 sm:space-y-2 text-sm sm:text-base md:text-[14px] xl:text-[16px] 2xl:text-3xl 2xl:leading-relaxed 2xl:tracking-wider">
                            ...
                            <li><strong>Documentaion Requirement:</strong> The following documents are typically required for the UAE Employment Visa application:
                                <ul className='list-disc pl-4 sm:pl-6 mt-2 sm:mt-3 space-y-1 sm:space-y-2 text-sm sm:text-base md:text-[14px] xl:text-[16px] 2xl:text-3xl 2xl:leading-relaxed 2xl:tracking-wider'>
