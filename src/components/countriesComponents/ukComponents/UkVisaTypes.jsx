...
const UkVisaTypes = () => {
    return (
        <div className="p-2 bg-white px-[15px] md:px-[3rem] lg:px-[10rem]" id='uk-study'>
            ...
            <div className="mb-6">
                <div className="flex flex-col md:flex-row items-top mb-4 2xl:space-x-15">
                    <div className="md:w-1/2 2xl:w-[60%]">
                        <h3 className="text-lg md:text-xl 2xl:text-4xl font-semibold text-gray-700">1. Student/Study Visa:</h3>
                        <p className="text-gray-600 mt-2 text-[15px] 2xl:text-2xl text-justify 2xl:tracking-wider 2xl:leading-normal">
                ...
                <div>
                    <h4 className="text-lg 2xl:text-4xl font-medium text-gray-700 mt-2">What are the eligibility requirements for a Study/student visa for UK?</h4>
                    <p className="text-gray-600 mt-2 text-[15px] 2xl:text-2xl 2xl:tracking-wider 2xl:leading-normal text-justify">The eligibility requirements for a UK study/student visa typically include:</p>
                    ...
                    <p className="text-gray-600 mt-2 text-[15px] 2xl:text-2xl 2xl:tracking-wider 2xl:leading-normal text-justify">It is important to note that the specific requirements may vary depending on the type of course, institution, and individual circumstances. It is advisable to consult with an immigration expert or the official UK government website for the most up-to-date and accurate information regarding UK study visa requirements.</p>
                </div>
