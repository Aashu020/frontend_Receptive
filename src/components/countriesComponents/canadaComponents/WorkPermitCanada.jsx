    ...
    <section className="w-full bg-white py-5 px-[15px] md:px-[3rem] lg:px-[10rem]">
      <div className="container px-1 flex flex-col md:flex-row items-start gap-8">
        ...
        <div className="md:w-[70%]">
          ...
          <p className="text-gray-700  2xl:text-2xl font-medium mb-2 text-justify text-[15px]">
          ...
          <p className="text-gray-600 mb-4 2xl:text-2xl leading-relaxed text-justify text-[15px]">
            <strong >Canadian work Permit made easy;</strong> <br />
            The ultimate guide to the Canadian work permit and visa process.
          </p>

          <p className="text-gray-600 2xl:text-2xl mb-6 leading-relaxed text-justify text-[15px]">
        ...
        <div className="md:w-[35%] flex justify-center">
          <img
            ...
            className="w-full  max-w-sm  2xl:max-w-2xl rounded-lg shadow-md"
          />
        </div>
      </div>
      <div>
          <h3 className="text-xl font-semibold  2xl:text-2xl text-gray-800 mb-3 text-justify text-[17px] mt-10 md:mt-0">
          ...
          <div className="space-y-6">
            <div>
              <h4 className="font-semibold 2xl:text-2xl text-gray-800 mb-2 text-justify text-[16px]">
                Requiring a Labour Market Impact Assessment (LMIA):
              </h4>
              <ul className="list-disc 2xl:text-2xl 2xl:tracking-wider 2xl:leading-normal pl-6 text-gray-600 space-y-1 text-justify text-[15px]">
