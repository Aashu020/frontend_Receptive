...
import img from "../../../assets/images/obtaincnadapermit.jpg"
const ObtainWorkPermitCanada = () => {
    return (
        <div className='px-[15px] md:px-[3rem] lg:px-[10rem] bg-white'>
            <div className="container px-1 flex flex-col md:flex-row items-start gap-8">
                {/* Left Content */}
                <div className="md:w-[60%]">
                    <h2 className="text-lg 2xl:text-6xl font-bold text-[#0C3B34] mb-4">
                        How to obtain a Canadian work permit?
                    </h2>

                    <p className="text-gray-700 2xl:text-2xl 2xl:tracking-wider 2xl:leading-normal font-medium mb-2 text-justify text-[15px]">
                ...
                <div className="md:w-[40%] flex justify-center">
                    <img
                        ...
                        className="w-full max-w-sm  2xl:max-w-3xl rounded-lg shadow-md"
                    />
                </div>
            </div>
            
            <div className="  min-h-screen">
                {/* Section 1: Benefits of a Canadian Work Permit */}
                <div className=" mt-2 mb-8">
                    <h1 className="text-lg 2xl:text-5xl font-bold text-[#0C3B34] mb-2">
                        What are the benefits of a Canadian Work Permit?
                    </h1>

                    <p className="text-gray-700 mb-4  2xl:text-2xl 2xl:tracking-wider 2xl:leading-normal  xl:text-5xltext-[15px] text-justify">
                        There are several benefits of holding a Canadian work permit:
                    </p>

                    <div className="space-y-6 text-justify">
                        <div>
                            <h3 className="text-[16px] 2xl:text-2xl font-semibold text-[#0C3B34] mb-2">
                                1. Legal authorization to work in Canada:
                            </h3>
                            <p className="text-gray-600  2xl:text-2xl 2xl:tracking-wider 2xl:leading-normal text-[15px]">
                    ...
                    <div className="mt-8">
                        <h2 className="text-[16px]  2xl:text-2xl font-bold text-[#0C3B34] mb-4">
                            How Can Receptive Immigration help you find your dream job in Canada?
                        </h2>
                        <p className="text-gray-700 2xl:text-2xl 2xl:tracking-wider 2xl:leading-normal mb-6 text-[15px]">
                        ...
                        <div className="space-y-4">
                            <div>
                                <h4 className="text-[16px]  2xl:text-2xl font-semibold text-[#0C3B34] mb-2">
                ...
                <div className="">
                    <h1 className="text-xl font-bold 2xl:text-2xl text-[#0C3B34] mb-4">
                        What documents are required to apply for a job in Canada?
                    </h1>

                    <p className="text-gray-700 2xl:text-2xl mb-6 text-[15px]">
                        Depending on the kind of work permit you're applying for, there may be certain documents needed. As part of their work permit application, applicants might need to submit the following documents:
                    </p>

                    <div className="bg-blue-50 p-1 rounded-lg mb-6">
                        <ul className="space-y-2  text-gray-700 text-[15px] 2xl:text-2xl 2xl:tracking-wider 2xl:leading-normal">
                            <li>• CV/ resume</li>
                            ...
                            <li>• A written offer of employment (if applicable)</li>
                            <li>• Marriage certificate (if applicable)</li>
                            <li>• Certificate d'acceptation du Québec (CAQ) (if applicable)</li>
                    ...
                    <div className="space-y-6">
                        <div>
                            <h3 className="text-[16px] 2xl:text-2xl font-semibold text-[#0C3B34] mb-3">
                                Police Clearance for work Permits:
                            </h3>
                            <p className="text-gray-600 2xl:text-2xl 2xl:tracking-wider 2xl:leading-normal mb-3 text-[15px]">
                        ...
                        <div>
                            ...
                            <div className="bg-yellow-50 p-4 rounded-lg">
                                <ul className="space-y-2 text-gray-700 text-[15px] 2xl:text-2xl 2xl:tracking-wider 2xl:leading-normal">
                                    <li>• You plan to work in a profession that involves contact with the listed countries specified in the provided link.</li>
                                    <li>• You have resided in or visited one of the countries listed on Canada's "Find out if you need a medical exam" website for a period exceeding six months.</li>
                                    <li>• Medical examinations must be conducted by a panel doctor designated by the IRCC. You can find a panel doctor in your area on the IRCC's Find a Panel Physician webpage.</li>
                                </ul>
                            </div>
                            <p className="text-gray-600 2xl:text-2xl 2xl:tracking-wider 2xl:leading-normal mt-4 text-[15px]">
...
export default ObtainWorkPermitCanada