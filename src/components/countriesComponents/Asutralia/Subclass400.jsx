  ...
  return (
    <div id='australia-subclass-400' className="w-full rounded-xl overflow-hidden bg-white mt-10  px-6 md:px-12 lg:px-24 text-left">
      ...
      <div className="flex flex-col items-start mb-6">
        <h2 className="text-3xl 2xl:text-5xl font-bold mb-4 text-left" style={{ color: '#0C3B34' }}>
      ...
      <div className="flex flex-col">
        <div className="mb-6">
          <h3 className="text-xl 2xl:text-4xl font-semibold mb-3 text-left" style={{ color: '#0C3B34' }}>
            What is Subclass Program 400 and why should one opt for it?
          </h3>
          <p className="text-left 2xl:text-2xl 2xl:tracking-wide leading-normal text-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <ul className="list-disc list-inside space-y-2 text-left text-gray-700 2xl:text-2xl 2xl:tracking-wide leading-normal">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <ul className="list-disc list-inside space-y-2 2xl:text-2xl 2xl:tracking-wide leading-normal text-left text-gray-700">
